...
exports.LTTPDistribution = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const lttpDistributionSchema = new mongoose_1.default.Schema({
    date: {
        type: Date,
        required: true
    },
    ...
    unit1: {
        unitId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Unit' },
        ...
        distributedBy: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User' },
        receivedBy: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User' }
    },
    ...
    // Approval workflow
    approvalFlow: {
        requestedBy: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User' },
        requestedAt: { type: Date },
        approvedBy: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User' },
        approvedAt: { type: Date },
        rejectedBy: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User' },
...
exports.LTTPDistribution = mongoose_1.default.model('LTTPDistribution', lttpDistributionSchema);
